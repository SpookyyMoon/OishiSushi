...
public class ContenedorCuentaAdaptador extends RecyclerView.Adapter<ContenedorCuentaAdaptador.PlatoViewHolder> {
    List<Platos> listaPlatos;

    public ContenedorCuentaAdaptador(List<Platos> listaPlatos){
    ...
    public PlatoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.plantilla_plato_cuenta, parent, false);
